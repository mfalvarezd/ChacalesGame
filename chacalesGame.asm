...
actualizar_tablero:         
    ...
    add     $t0,                $t0,                        $t1                                                     # Calcular la dirección del elemento del arreglo

    li      $t2,                1                                                                                   # Valor que queremos almacenar en el arreglo
    sw      $t2,                0($t0)                                                                              # Almacenar el valor 1 en la posición calculada del arreglo
